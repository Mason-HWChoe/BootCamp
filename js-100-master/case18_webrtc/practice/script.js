;(() => {
  ...
  class WebRtc {
    constructor() {
      ...
      this.btbDownload = get('.btn_download')
    ...
    events() {
      ...
      this.btbDownload.addEventListener('click', this.download.bind(this))
    }
    ...
    toggleRecord() {
      if ('녹화' === this.btnRecord.textContent) {
        ...
        this.btbDownload.removeAttribute('disabled')
    ...
    startRecord() {
      ...
      this.btbDownload.setAttribute('disabled', true)
